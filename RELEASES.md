...
- [ ] Verify OSCAL baseline catalog generation and OSCAL CLI schema validation pass for all Markdown baselines.
...
- [ ] Verify that the GitHub release contains scubagoggles-oscal-baseline-catalog-vX.Y.Z.zip
- [ ] Verify that the OSCAL catalog zip contains scubagoggles-vX.Y.Z-oscal-catalog-oscal-A.B.C.json
