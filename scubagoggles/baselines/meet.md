...
#### GWS.MEET.1.1v0.6
All users (including users not signed in with a Google account) SHOULD be enabled to join meetings.

- _Rationale:_ Allowing all users to join meetings facilitates collaboration and reduces the temptation for users without managed Workspace accounts to use personal Google accounts to join meetings.
