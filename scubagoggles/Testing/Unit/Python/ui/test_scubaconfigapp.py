...
class TestScubaConfig:
    ...
    @pytest.mark.parametrize('dark, expected_css', [
        (
            True,
    ...
    def test_generate_css(self, monkeypatch, dark, expected_css):
        """
        ...
        """
        monkeypatch.setenv("SCUBAGOGGLES_UI_DARK", "1" if dark else "")
