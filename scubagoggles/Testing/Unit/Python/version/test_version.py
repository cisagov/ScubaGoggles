...
class TestVersion:  # pylint: disable=too-many-public-methods
    ...
    def setup_method(self):
        ...
        Version._baseline_version_map = {}  # pylint: disable=protected-access
    ...
    @pytest.mark.parametrize('data, expected_success', [
        ('GWS.CHAT.1.1v1', True),
        ('GWS.CHAT.1.1v0 and GWS.GMAIL.2.1v0', False),
    ...
    def test_check_version_consistent_suffixes(self):
        ...
        success, errors = Version.check_version('GWS.CHAT.1.1v1')
        ...
        # Different suffix should fail
        success, errors = Version.check_version('GWS.CHAT.1.1v2')
        assert success is False
        assert 'GWS.CHAT.1.1' in errors
    ...
    def test_check_or_update_readme_check_mode(self, mocker):
        ...
        # The current version is beyond the following, so this will always
        # cause the check to return True because the versions will not
        # match.
    ...
    def test_log_version_errors(self, mocker):
        ...
        for call in mock_log.error.call_args_list:
            ...
            assert any(policy_id in str(args) for policy_id in errors)
    ...
    def test_version_regex_patterns(self):
        ...
        assert suffix_match_minor is None
