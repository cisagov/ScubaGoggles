...
# GWS.GEMINI.1.2
#--
test_1_2_Correct_V1 if {
    PolicyId := GeminiId1_2
    Output := tests with input as {
        "gemini_logs": {"items": [
            {
                "id": {"time": "2022-12-20T00:02:28.672Z"},
                "events": [{
                    "parameters": [
                        {
                            "name": "SETTING_NAME",
                            "value": "BardExtensionsFirstPartyProto allow_first_party_extensions"
                        },
                        {"name": "NEW_VALUE", "value": "false"},
                        {"name": "ORG_UNIT_NAME", "value": "topOU"},
                    ]
...
test_1_2_Correct_V2 if {
    # Other app access enabled but Gemini disabled for OU
    PolicyId := GeminiId1_2
    Output := tests with input as {
        "gemini_logs": {"items": [
            {
...
test_1_2_Incorrect_V1 if {
    # Other app access enabled
    PolicyId := GeminiId1_2
    Output := tests with input as {
        "gemini_logs": {"items": [
            {
    ...
    RuleOutput[0].ReportDetails == concat("", [
        "The following OUs are non-compliant:<ul>",
        "<li>topOU: Gemini access to other Google apps is enabled.</li></ul>"
    ])
}
#--