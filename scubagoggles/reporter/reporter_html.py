...
def insert_classroom_warning(html: str, full_name: str) -> str:
    """Insert a product-specific warning note into the HTML based on the control name."""
    classroom_note = (
...
def _normalize_indicator_link(link_url: str | None, *, product: str | None,
...
def render_indicator_badge(indicator: dict, *, product: str | None = None,
    ...
    """
    Render an HTML badge element for a policy indicator, optionally linking to
    a product-specific or GitHub URL.
    """
...
def render_indicators(indicators: list, *, product: str | None = None,
                      github_url: str = GITHUB_URL) -> str:
...
def build_indicator_legend(product_policies: list, *, product: str | None = None,
                           github_url: str = GITHUB_URL) -> str:
    """
    Build an HTML legend for all unique policy indicators found in product_policies.
    """
