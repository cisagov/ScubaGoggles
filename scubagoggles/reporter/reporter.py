...
class Reporter:
    ...
    def build_front_page_html(cls,
        ...
        return rh.build_front_page_html(fragments,
                                        tenant_info,
                                        report_uuid,
                                        darkmode,
                                        redaction)
    ...
    def _is_control_omitted(self, control_id: str) -> bool:
        ...
        """Determine if the supplied control was marked for omission in
        the config file.
        """
    ...
    def _is_control_marked_incorrect(self, control_id: str) -> bool:
        ...
        """Determine if the supplied control was marked incorrect in the
        config file.
        """
    ...
    def _build_comments_array(self, control_id: str) -> list:
        ...
        """Build array of comments containing omission rationale and
        annotation comment.
        """
    ...
    def _add_annotation(self, control_id: str, result: str, details: str):
        ...
        """Append annotation content (comment/incorrect-result/remediation
        date) if applicable.
        """
    ...
    def _process_control(self,
                         ...
                         report_stats: dict,
                         github_url: str,
                         rules_data: dict | None) -> tuple[list[dict], dict | None]:

        """Process a single control and return its table rows and updated
        rules_data.
        """
    ...
    def _build_group_output(self,
                            baseline_group: dict,
                            product: str,
                            product_upper: str,
                            github_url: str,
                            table_data: list[dict]) -> tuple[list[str], dict]:
    ...
    def _build_report_html(self,
        ...
        """Delegate HTML assembly to _reporter_html and capture rules_table
        for the orchestrator.
        """

        legend_html = rh.build_indicator_legend(self._product_policies,
                                                product=self._product)
        if legend_html:
    ...
    def _process_baseline_group(self,
                                baseline_group: dict,
                                test_results: list,
                                report_stats: dict,
                                github_url: str,
                                product: str,
                                product_upper: str,
                                rules_data: dict | None) -> tuple[list[str], dict, dict | None]:

        """Process a single baseline group and return HTML fragments,
        JSON data, and rules_data.
        """
    ...
    def rego_json_to_ind_reports(self,
        ...
        """Transforms the Rego JSON output into individual HTML and JSON
        reports.
        """
        ...
        for baseline_group in self._product_policies:
            group_fragments, results_data, rules_data = (
                self._process_baseline_group(baseline_group,
                                             test_results,
                                             report_stats,
                                             github_url,
                                             product,
