...
8.  Select the rule by clicking the table row for the rule.
9. Click **Next: View Conditions**.
10. Click **Next: Add Actions**.
11. From the Actions page, you can change the severity for the alert to High, Medium, or Low, send an alert to the alert center if the rule's conditions are met, set up admin email notifications, and specify recipients for those notifications.
12. Click **Next: Review**.
13. Review the updated rule details, and then click **Update Rule**.
