...
7.  Click **Apply**.
8.  A list of system defined rules displays. For each of the rules from listed above edit the configuration:
9.  Select the rule by clicking the table row for the rule.
