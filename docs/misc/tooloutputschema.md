...
| ResolutionDate | String or null | Will be either remediation date or omission expiration date; if configured both omission date and a remedation date, the omission date takes precidence; if configured neither, this will be null | 2024-08-01 | N/A|
